...
const MyBookings = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            <Title title="My Bookings" subTitle="eaihrgoaghrraeghjlkfsdghaurghrebguiasgnusanviwaenguvnuaygewvngytayngwevtnygaeswynvgawevynkutynkwugnvkgywenygkuvky" aling="left"/>
                    ...
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                        ...
                        <div className='flex flex-col items-start justify-center pt-3'>
                            <div className='flex items-center gap-2'>
                                <div className={`h-3 w-3 rounded-full ${booking.isPaid ? "bg-green-500" : "bg-blue-500" }`}></div>
                                <p className={`text-sm ${booking.isPaid ? "text-green-500" : "text-blue-500" }`}>
