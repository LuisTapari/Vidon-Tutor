...
const NewsLetter = () => {
    return (
        <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            ...
            <Title title="Stay Inspired" subTitle="Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, magnam veritatis repudiandae veniam blanditiis dolores harum voluptate ipsum quisquam repellat dicta rem obcaecati fugit inventore molestiae mollitia nostrum laboriosam sed." />
